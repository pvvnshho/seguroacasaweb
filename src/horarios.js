...
import HorariosComponente from '../src/componentes/HorariosComponente'; // Asegúrate de que la ruta sea correcta
...
function DemoPageContent() {
  return (
    ...
    >
      ...
      <HorariosComponente /> {/* Aquí se inserta tu componente de horarios */}
    </Box>
  );
}
