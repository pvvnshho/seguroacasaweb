...
import RutaComponente from '../src/componentes/RutaComponente'; // Asegúrate de que la ruta sea correcta
...
function DemoPageContent() {
  return (
    ...
    >
      <Typography>Contenido de ruta</Typography>
      <RutaComponente /> {/* Aquí se inserta tu componente de ruta */}
    </Box>
  );
}
