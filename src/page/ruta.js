...
import RutaComponente from '../componentes/RutaComponente'; // Asegúrate de que la ruta sea correcta
...
function DemoPageContent() {
  return (
    ...
    >
      <RutaComponente /> {/* Componente de perfil */}
    </Box>
  );
}
    ...
    <ThemeProvider theme={theme}>
      <AppProvider
        navigation={[
          ...
          {
            segment: 'ruta',
            title: <span style={{ fontSize: '18px' }}>Mapa</span>,
