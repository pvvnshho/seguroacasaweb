...
import FurgonesComponente from '../componentes/FurgonesComponentes';
...
function GestionFurgones(props) {
  const { window } = props;
    ...
    <ThemeProvider theme={theme}>
      <AppProvider
        navigation={[
          ...
          {
            segment: 'gestionPagos',
            title: <span style={{ fontSize: '18px' }}>Gestión Pagos</span>,
            icon: <RouteIcon sx={{ fontSize: 40 }} />,
            onClick: () => navigate('/gestionPagos'),
          },
          {
...
GestionFurgones.propTypes = {
  window: PropTypes.func,
};

export default GestionFurgones;
