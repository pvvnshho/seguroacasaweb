...
import ConductorComponente from '../src/componentes/ConductorComponente'; // Asegúrate de que la ruta sea correcta
...
function DemoPageContent() {
  return (
    ...
    >
      ...
      <ConductorComponente /> {/* Aquí se inserta tu componente de conductor */}
    </Box>
  );
}
